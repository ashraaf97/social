package com.beam.social.donation;
...
import com.beam.social.model.OverlayPosition;
import com.beam.social.model.TtsStatus;
import com.beam.social.model.User;
import com.beam.social.model.UserRole;
import com.beam.social.repository.DonationRepository;
import com.beam.social.repository.OverlayEventRepository;
import com.beam.social.repository.UserRepository;
import com.beam.social.service.AiReaderService;
...
class DonationIntegrationTest {
    ...
    private static final String STREAMER_DONATION_TOKEN = "test-donation-token";
    private static final String STREAMER_OVERLAY_TOKEN = "test-overlay-token";
    ...
    void setUp() {
        ...
        userRepository.save(new User(
                ...
                "streamer-it@example.com",
                UserRole.STREAMER,
                STREAMER_ID,
                STREAMER_OVERLAY_TOKEN,
                STREAMER_DONATION_TOKEN,
    ...
    void createDonationPersistsRecord() throws Exception {
        final String body = """
                ...
                """.formatted(STREAMER_DONATION_TOKEN);
    ...
    void overlayPollSurfacesPaidDonationOnly() throws Exception {
        ...
        mockMvc.perform(get("/api/v1/overlay/events")
                        .param("token", STREAMER_OVERLAY_TOKEN)
                        .param("cursor", "0"))
                .andExpect(status().isOk())
    ...
    private Donation newPendingDonation(String senderName, String message) {
        return donationService.createDonation(
                new com.beam.social.model.request.CreateDonationInput(
                        STREAMER_ID,
                        senderName,
                        new BigDecimal("5.00"),
                        "MYR",
